        ...
        <SideSheet.HeaderDefaultLayout
          ...
          contentSlot={
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <Typography component="span" variant="overlineSmall" style={{ color: '#4740D4', textTransform: 'uppercase' }}>
                SCHEDULE
              </Typography>
            </div>
          }
            ...
            <div style={{ padding: '16px' }}>
              ...
              >
                <div style={{ padding: '16px 16px 0 16px' }}>
                  <Typography variant="labelLarge" component="div" style={{ marginBottom: '16px' }}>
                    Details
                  </Typography>
                </div>
                <div style={{ padding: '0 16px 16px 16px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    {/* Assigned by */}
                    <div style={{ display: 'flex', gap: '24px', alignItems: 'center', minHeight: '40px' }}>
                      <div style={{ display: 'flex', gap: '4px', alignItems: 'center', minWidth: '140px' }}>
                        <User size={16} color="#545f70" />
                        <Typography variant="labelMedium" component="span" style={{ color: '#545f70' }}>
                          Assigned by
                        </Typography>
                      </div>
                      <div style={{
                  ...
                  >
                    <CalendarExclamation size={20} color="#9E4A00" style={{ flexShrink: 0, marginTop: '2px' }} />
                    <div>
                      <Typography
                        variant="titleSmall"
                        component="div"
                      ...
                      <Typography variant="bodySmall" component="div" style={{ color: '#9E4A00' }}>
